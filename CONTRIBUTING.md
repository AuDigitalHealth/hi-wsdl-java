...
The **first number** of **`au.gov.nehta:hi-wsdl`** is the **Java SE** version that this types JAR targets. **8.0.0** is **`javax`** with **14** `Service` stubs; **11.0.0.1** and later are **Jakarta** with **26** stubs. See **`README.md`**.
...
This line (**`8.0.0`**) compiles **committed** types - it does **not** run **`wsimport`**.
...
- **`8.0.0`:** generated Java under **`src/main/java`** is frozen - this POM has no **`wsimport`** / XJC profile.
