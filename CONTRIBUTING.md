...
This line (**`17.0.0`**) compiles **committed** types. Regeneration is a maintainer profile only (below).
...
2. Jakarta **`wsimport`** tooling aligned with **`MAINTAINERS.md`** (**`jaxws-rt`** 4.0.x, Java 17).
...
- **`17.0.0`:** generated Java under **`src/main/java`** is committed; use **`-Pregenerate-sources`** only when refreshing types from licensed WSDL.
