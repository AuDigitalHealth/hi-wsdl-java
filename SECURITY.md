...
- **Licensed MCA WSDL/XSD download tree:** on **11.0.0.1** and later regeneration lines, the full ADHA bundle under **`wsdls/xml/`** (or equivalent) must stay out of Git. This **8.0.0** line ships only the standard HI B2B binding WSDL set under **`src/main/resources/`** as published artifact content.
