 ...
 * 
 */
@WebService(name = "ConsumerUpdateIHIPortType", targetNamespace = "http://ns.electronichealth.net.au/hi/svc/ConsumerUpdateIHI/3.2.0")
@SOAPBinding(parameterStyle = SOAPBinding.ParameterStyle.BARE)
@XmlSeeAlso({
    au.net.electronichealth.ns.hi.svc.consumerupdateihi._3_2.ObjectFactory.class,
    ...
    au.net.electronichealth.ns.hi.xsd.consumercore.name._3_2.ObjectFactory.class,
    au.net.electronichealth.ns.hi.xsd.consumermessages.updateihi._3_2.ObjectFactory.class,
...
public interface ConsumerUpdateIHIPortType {
     ...
     * @param userHeader
     * @return
     *     returns au.net.electronichealth.ns.hi.svc.consumerupdateihi._3_2.UpdateIHIResponse
     * @throws StandardErrorMsg
     */
    @WebMethod
    @WebResult(name = "updateIHIResponse", targetNamespace = "http://ns.electronichealth.net.au/hi/svc/ConsumerUpdateIHI/3.2.0", partName = "response")
    @Action(input = "http://ns.electronichealth.net.au/hi/svc/ConsumerUpdateIHI/3.2.0/ConsumerUpdateIHIPortType/updateIHIRequest", output = "http://ns.electronichealth.net.au/hi/svc/ConsumerUpdateIHI/3.2.0/ConsumerUpdateIHIPortType/updateIHIResponse", fault = {
        @FaultAction(className = StandardErrorMsg.class, value = "http://ns.electronichealth.net.au/hi/svc/ConsumerUpdateIHI/3.2.0/ConsumerUpdateIHIPortType/updateIHI/Fault/standardError")
    })
    public UpdateIHIResponse updateIHI(
        @WebParam(name = "updateIHI", targetNamespace = "http://ns.electronichealth.net.au/hi/svc/ConsumerUpdateIHI/3.2.0", partName = "request")
        UpdateIHI request,
