 ...
 * 
 */
@WebService(name = "ConsumerResolveProvisionalIHIPortType", targetNamespace = "http://ns.electronichealth.net.au/hi/svc/ConsumerResolveProvisionalIHI/3.0.2")
@SOAPBinding(parameterStyle = SOAPBinding.ParameterStyle.BARE)
@XmlSeeAlso({
    au.net.electronichealth.ns.hi.svc.consumerresolveprovisionalihi._3_0.ObjectFactory.class,
    ...
    au.net.electronichealth.ns.hi.xsd.consumermessages.resolveprovisionalihi._3.ObjectFactory.class,
...
public interface ConsumerResolveProvisionalIHIPortType {
     ...
     * @param userHeader
     * @return
     *     returns au.net.electronichealth.ns.hi.svc.consumerresolveprovisionalihi._3_0.ResolveProvisionalIHIResponse
     * @throws StandardErrorMsg
     */
    @WebMethod(action = "http://ns.electronichealth.net.au/")
    @WebResult(name = "resolveProvisionalIHIResponse", targetNamespace = "http://ns.electronichealth.net.au/hi/svc/ConsumerResolveProvisionalIHI/3.0.2", partName = "response")
    @Action(input = "http://ns.electronichealth.net.au/hi/svc/ConsumerResolveProvisionalIHI/3.0.2/ConsumerResolveProvisionalIHIPortType/resolveProvisionalIHIRequest", output = "http://ns.electronichealth.net.au/hi/svc/ConsumerResolveProvisionalIHI/3.0.2/ConsumerResolveProvisionalIHIPortType/resolveProvisionalIHIResponse", fault = {
        @FaultAction(className = StandardErrorMsg.class, value = "http://ns.electronichealth.net.au/hi/svc/ConsumerResolveProvisionalIHI/3.0.2/ConsumerResolveProvisionalIHIPortType/resolveProvisionalIHI/Fault/standardError")
    })
    public ResolveProvisionalIHIResponse resolveProvisionalIHI(
        @WebParam(name = "resolveProvisionalIHI", targetNamespace = "http://ns.electronichealth.net.au/hi/svc/ConsumerResolveProvisionalIHI/3.0.2", partName = "request")
        ResolveProvisionalIHI request,
