...
public class ObjectFactory {
    ...
    private static final QName _IhiNumber_QNAME = new QName("http://ns.electronichealth.net.au/hi/xsd/consumercore/ConsumerCoreElements/3.2.0", "ihiNumber");
    private static final QName _Comment_QNAME = new QName("http://ns.electronichealth.net.au/hi/xsd/consumercore/ConsumerCoreElements/3.2.0", "comment");
    private static final QName _IhiNumberStatusGroup_QNAME = new QName("http://ns.electronichealth.net.au/hi/xsd/consumercore/ConsumerCoreElements/3.2.0", "ihiNumberStatusGroup");
    private static final QName _BirthPlurality_QNAME = new QName("http://ns.electronichealth.net.au/hi/xsd/consumercore/ConsumerCoreElements/3.2.0", "birthPlurality");
    private static final QName _BirthOrder_QNAME = new QName("http://ns.electronichealth.net.au/hi/xsd/consumercore/ConsumerCoreElements/3.2.0", "birthOrder");
    private static final QName _SourceOfDeathNotification_QNAME = new QName("http://ns.electronichealth.net.au/hi/xsd/consumercore/ConsumerCoreElements/3.2.0", "sourceOfDeathNotification");
    private static final QName _MedicareIRN_QNAME = new QName("http://ns.electronichealth.net.au/hi/xsd/consumercore/ConsumerCoreElements/3.2.0", "medicareIRN");
    private static final QName _MedicareCardNumber_QNAME = new QName("http://ns.electronichealth.net.au/hi/xsd/consumercore/ConsumerCoreElements/3.2.0", "medicareCardNumber");
    private static final QName _DvaFileNumber_QNAME = new QName("http://ns.electronichealth.net.au/hi/xsd/consumercore/ConsumerCoreElements/3.2.0", "dvaFileNumber");
    private static final QName _IhiRecordStatus_QNAME = new QName("http://ns.electronichealth.net.au/hi/xsd/consumercore/ConsumerCoreElements/3.2.0", "ihiRecordStatus");
    private static final QName _IhiStatus_QNAME = new QName("http://ns.electronichealth.net.au/hi/xsd/consumercore/ConsumerCoreElements/3.2.0", "ihiStatus");
    private static final QName _History_QNAME = new QName("http://ns.electronichealth.net.au/hi/xsd/consumercore/ConsumerCoreElements/3.2.0", "history");
     ...
     * 
     * @return
     *     the new instance of {@link IHINumberStatusGroupType }
     */
     ...
     *     Java instance representing xml element's value.
     * @return
     *     the new instance of {@link JAXBElement }{@code <}{@link IHINumberStatusGroupType }{@code >}
     */
    ...
    public JAXBElement<IHINumberStatusGroupType> createIhiNumberStatusGroup(IHINumberStatusGroupType value) {
        return new JAXBElement<>(_IhiNumberStatusGroup_QNAME, IHINumberStatusGroupType.class, null, value);
    }
