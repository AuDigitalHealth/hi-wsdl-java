    ...
    extends Service
{
    ...
    private static final URL PROVIDERSEARCHHIPROVIDERDIRECTORYFORORGANISATIONSERVICE_WSDL_LOCATION;
    private static final WebServiceException PROVIDERSEARCHHIPROVIDERDIRECTORYFORORGANISATIONSERVICE_EXCEPTION;
    private static final QName PROVIDERSEARCHHIPROVIDERDIRECTORYFORORGANISATIONSERVICE_QNAME = new QName("http://ns.electronichealth.net.au/hi/svc/ProviderSearchHIProviderDirectoryForOrganisation/3.2.0", "ProviderSearchHIProviderDirectoryForOrganisationService");
