...
import au.net.electronichealth.ns.hi.xsd.consumermessages.mergeprovisionalihi._3.MergeProvisionalIHIResult;
...
public class MergeProvisionalIHIResponse {
    ...
    @XmlElement(namespace = "http://ns.electronichealth.net.au/hi/xsd/consumermessages/MergeProvisionalIHI/3.0", required = true)
