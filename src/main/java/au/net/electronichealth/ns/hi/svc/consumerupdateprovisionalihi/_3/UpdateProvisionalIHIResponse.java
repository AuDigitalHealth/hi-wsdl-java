...
import au.net.electronichealth.ns.hi.xsd.consumermessages.updateprovisionalihi._3.UpdateProvisionalIHIResult;
...
public class UpdateProvisionalIHIResponse {
    ...
    @XmlElement(namespace = "http://ns.electronichealth.net.au/hi/xsd/consumermessages/UpdateProvisionalIHI/3.0", required = true)
