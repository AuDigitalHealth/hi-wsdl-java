 ...
 * 
 */
@WebService(name = "ProviderSearchTdsProviderIndividualPortType", targetNamespace = "http://ns.electronichealth.net.au/hi/svc/ProviderSearchTdsProviderIndividual/5.1.0")
@SOAPBinding(parameterStyle = SOAPBinding.ParameterStyle.BARE)
@XmlSeeAlso({
    au.gov.medicareaustralia.ns.provider.schema._2013._06._22.elements.ObjectFactory.class,
    au.net.electronichealth.ns.hi.svc.providersearchtdsproviderindividual._5_1.ObjectFactory.class,
    ...
    au.net.electronichealth.ns.hi.xsd.providermessages.searchtdsproviderindividual._5_1.ObjectFactory.class,
...
public interface ProviderSearchTdsProviderIndividualPortType {
     ...
     * @param userHeader
     * @return
     *     returns au.net.electronichealth.ns.hi.svc.providersearchtdsproviderindividual._5_1.SearchTdsProviderIndividualResponse
     * @throws StandardErrorMsg
     */
    @WebMethod
    @WebResult(name = "searchTdsProviderIndividualResponse", targetNamespace = "http://ns.electronichealth.net.au/hi/svc/ProviderSearchTdsProviderIndividual/5.1.0", partName = "response")
    @Action(input = "http://ns.electronichealth.net.au/hi/svc/ProviderSearchTdsProviderIndividual/5.1.0/ProviderSearchTdsProviderIndividualPortType/searchTdsProviderIndividualRequest", output = "http://ns.electronichealth.net.au/hi/svc/ProviderSearchTdsProviderIndividual/5.1.0/ProviderSearchTdsProviderIndividualPortType/searchTdsProviderIndividualResponse", fault = {
        @FaultAction(className = StandardErrorMsg.class, value = "http://ns.electronichealth.net.au/hi/svc/ProviderSearchTdsProviderIndividual/5.1.0/ProviderSearchTdsProviderIndividualPortType/searchTdsProviderIndividual/Fault/standardError")
    })
    public SearchTdsProviderIndividualResponse searchTdsProviderIndividual(
        @WebParam(name = "searchTdsProviderIndividual", targetNamespace = "http://ns.electronichealth.net.au/hi/svc/ProviderSearchTdsProviderIndividual/5.1.0", partName = "request")
