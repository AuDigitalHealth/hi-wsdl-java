 ...
 *       &lt;sequence&gt;
 *         &lt;element name="searchIHIBatchRequest" type="{http://ns.electronichealth.net.au/hi/xsd/consumermessages/SearchIHIBatch/3.0}SearchIHIRequestType" maxOccurs="100"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "searchIHIBatchSync")
public class SearchIHIBatchSync {
     ...
     * This is why there is not a <CODE>set</CODE> method for the searchIHIBatchRequest property.</p>
     * 
     * <p>
